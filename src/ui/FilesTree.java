                ...
                if (f != null && f.isDirectory()) {
                    ...
                    if (files != null) {
                        ...
                        for (int i = 0; i < files.length; i++) {
                            ...
                            for (String listOpenedProject : FXSplitTabs.listOpenedProjects) {
        ...
        //while (true) 
        {
            ...
            tv.setOnMouseClicked((MouseEvent mouseEvent) -> {
                if (mouseEvent.getClickCount() % 2 == 0) {
                    ...
                    System.out.println("Selected Project Is:" + getProjectName(item.getValue()));
                    String projectName = getProjectName(item.getValue());
                    if (projectName != null && !(MainWindow.selectedProject.trim().equalsIgnoreCase(projectName.trim()))) {
                        MainWindow.selectedProject = projectName.trim();
                        MainWindow.loadManifest(new File("workspace/"+MainWindow.selectedProject));
                    }
                }
            });
        }
